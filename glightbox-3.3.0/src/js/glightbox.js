...
class GlightboxInit {
    constructor(options = {}) {
        this.customClasses = options.customClasses || ''; // New line to accept additional CSS classes
    ...
    updateContent(newContent) {
        // Method to update the lightbox content dynamically
        this.slidesContainer.innerHTML = newContent;
    }
